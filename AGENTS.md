...
requires a *property access* -- dividing by a million is legitimate as a
...
*negative* base, which inverts the sign -- a spread falling from -5 to -10
reported `+100%`.
...
1,092 tests across 31 files. **The full suite takes roughly 20 to 40 minutes**,
